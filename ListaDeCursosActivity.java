...
public class ListaDeCursosActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        arrgegloCursos = leerArchivoTextoCursos("arrgegloCursos");
        if (arrgegloCursos == null) {

            databaseReference.child("Cursos").addChildEventListener(new ChildEventListener() {
                ...
                public void onChildAdded(@NonNull DataSnapshot dataSnapshot, @Nullable String s) {
                    ...
                    lista = cursos;
                    ListaCursosAdapter adapter=new ListaCursosAdapter(lista,ListaDeCursosActivity.this);
                    RecyclerView recyclerView=findViewById(R.id.RViewCursos);
                    recyclerView.setAdapter(adapter);
                    recyclerView.setLayoutManager(new LinearLayoutManager(ListaDeCursosActivity.this));
            ...
            ListaCursosAdapter adapter=new ListaCursosAdapter(arrgegloCursos,ListaDeCursosActivity.this);
            RecyclerView recyclerView=findViewById(R.id.RViewCursos);
            recyclerView.setAdapter(adapter);
            recyclerView.setLayoutManager(new LinearLayoutManager(ListaDeCursosActivity.this));
